    ...
    void XUpdate()
    {
        ...
        if (ActiveChange)
        {
            if (CanvasSpriteRenderer != null)
            {
                ...
                CanvasSpriteRenderer.sharedMaterial.SetFloat("_Distortion", Colors);
            }
            else if (CanvasImage != null)
            {
...
#if UNITY_EDITOR
[CustomEditor(typeof(BurningFX)), CanEditMultipleObjects]
public class _2dxFX_BurningFX_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        BurningFX _2dxScript = (BurningFX)target;
