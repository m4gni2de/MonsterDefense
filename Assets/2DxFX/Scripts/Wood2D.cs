...
[System.Serializable]
public class Wood2D : MonoBehaviour
{
...
//#endif
        if (ActiveChange)
        {
            if (CanvasSpriteRenderer != null)
            {
                ...
                CanvasSpriteRenderer.sharedMaterial.SetFloat("_Distortion", IntoWood);
...
#if UNITY_EDITOR
[CustomEditor(typeof(Wood2D)), CanEditMultipleObjects]
public class _2dxFX_WoodFX_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Wood2D _2dxScript = (Wood2D)target;
