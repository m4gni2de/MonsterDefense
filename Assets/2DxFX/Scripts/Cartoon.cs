    ...
    void XUpdate()
    {
        ...
        if (ActiveChange)
        {
            if (CanvasSpriteRenderer != null)
            {
                ...
                CanvasSpriteRenderer.sharedMaterial.SetFloat("_ColorLevel", _ColorLevel);
                CanvasSpriteRenderer.sharedMaterial.SetFloat("_EdgeSize", _EdgeSize);
            }
            else if (CanvasImage != null)
            {
...
#if UNITY_EDITOR
[CustomEditor(typeof(Cartoon)), CanEditMultipleObjects]
public class _2dxFX_Cartoon_Editor : Editor
{
    ...
    public override void OnInspectorGUI()
    {
        ...
        Cartoon _2dxScript = (Cartoon)target;
