...
public class MapDetails : MonoBehaviour
{
    ...
    public void LoadMap(string name)
    {
        ...
        for (int i = 1; i < rows * 2; i++)
        {
                ...
                tile.GetComponent<MapTile>().roadSprite.sortingOrder = 1 + (int)-tile.transform.position.y;
                ...
                tile2.GetComponent<MapTile>().roadSprite.sortingOrder = 1 + (int)-tile2.transform.position.y;
